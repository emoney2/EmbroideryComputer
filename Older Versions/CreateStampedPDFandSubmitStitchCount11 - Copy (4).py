    ...
    try:
        ...
        proc = subprocess.Popen(
            [
                ...
                f"--window-position={SECONDARY_X},{SECONDARY_Y}",
        ...
        # --- Move ONLY the new Chrome window ---
...
def _scanner_keyboard_hook(e):
    ...
    return False  # ALWAYS suppress typing
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"[Monitors] PRIMARY=({PRIMARY_X},{PRIMARY_Y}), SECONDARY=({SECONDARY_X},{SECONDARY_Y})")
    except Exception as e:
    ...
    try:
        SCANNER_HOOK = keyboard.on_press(_scanner_keyboard_hook, suppress=True)
        print("[Startup] Scanner listener registered (suppressed).")
    except Exception as e:
...
keyboard.hook(_scanner_keyboard_hook, suppress=True)
print("[Scanner] Suppressed scanner hook installed")
