...
SUMATRA_PATH = r"C:\Users\Embroidery1\AppData\Local\SumatraPDF\SumatraPDF.exe"
HOTKEY_O  = "ctrl+alt+o"
...
# ============================================================
# PRINT SERVER FUNCTIONALITY (from JRCO_PrintServer.py)
# ============================================================
...
# ============================================================
# UPS LABEL WATCHER (from JRCO_PrintServer.py)
# ============================================================

WATCH_FOLDER = r"G:\My Drive\Label Printer"
PRINTER_NAME = "PL80E"

# Import Image separately for label printing functions
...
if __name__ == "__main__":
    ...
    # Start UPS Label watcher thread
    try:
        label_watcher_thread = threading.Thread(target=start_label_watcher, daemon=True)
        label_watcher_thread.start()
        print("[Startup] UPS Label watcher thread started.")
    except Exception as e:
        print("[Startup] UPS Label watcher failed to start:", e)
